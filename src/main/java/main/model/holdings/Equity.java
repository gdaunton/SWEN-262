...
public class Equity extends Holding implements Serializable {
	 ...
	 * @param shares
	 *            The ammount of shares in the Equity
	 * @param price_per_share
	 *            The price of each share of the Equity
	 * @param marketSectors
	 *            The different markets that the Equity can be in
	 */
	 ...
	 * 
	 * @param shares
	 *            The new ammount of shares in the Equity
	 */
	 ...
	 * 
	 * @param price_per_share
	 *            The new price per share of the Equity
	 */
